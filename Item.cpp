...
Item::Item(int id, int x, int y, const item_stub::item_stub* stub) : id(id), x(x), y(y), color(item_stub::getColor(stub->color)), hit(item_stub::parse_dice(stub->hit)), damage(""),
