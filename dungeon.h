...
// void addCharcters(Dungeon* dungeon, std::priority_queue<Player, std::vector<Player> >* evt, int nummon, Player* characters[], int chars[][nCols], unsigned int pace[]);
...
// void clear_queue(std::priority_queue<Player*, std::vector<Player*>, PlayerComparator>* q); //TODO remove
